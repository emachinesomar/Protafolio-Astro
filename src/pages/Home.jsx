...
const StatusBadge = memo(() => (
    <div className="inline-block animate-float lg:mx-0" data-aos="zoom-in" data-aos-delay="400">
        <div className="relative group">
            ...
            <div className="relative px-3 sm:px-4 py-2 rounded-full bg-black/10 backdrop-blur-xl border border-white/10">
...
const Home = () => {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-[#0f172a] overflow-hidden" id="Home">
                        ...
                        <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
                            ...
                            <div className="space-y-4 sm:space-y-6">
                                ...
                                <div className="h-8 flex items-center" data-aos="fade-up" data-aos-delay="800">
                                    <span className="text-xl md:text-2xl bg-gradient-to-r from-gray-800 to-gray-600 dark:from-gray-100 dark:to-gray-300 bg-clip-text text-transparent font-light">
                                        {text}
                                    </span>
